...
static const struct sensor_t sSensorList[] = {
        { "LSM330DLC Acceleration Sensor",
          ...
          SENSOR_TYPE_ACCELEROMETER, RANGE_A, CONVERT_A, 0.23f, 20000, 0, 0, 0, 0, 0,
		SENSOR_FLAG_ON_CHANGE_MODE, {}, },
        { "AK8963C Magnetic field Sensor",
          "Asahi Kasei Microdevices",
          1, SENSORS_MAGNETIC_FIELD_HANDLE,
          SENSOR_TYPE_MAGNETIC_FIELD, 2000.0f, CONVERT_M, 6.8f, 16667, 0, 0, 0, 0, 0,
		SENSOR_FLAG_ON_CHANGE_MODE, {}, },
        { "AK8963C Orientation Sensor",
          "Asahi Kasei Microdevices",
          1, SENSORS_ORIENTATION_HANDLE,
          SENSOR_TYPE_ORIENTATION, 360.0f, CONVERT_O, 7.8f, 16667, 0, 0, 0, 0, 0,
		SENSOR_FLAG_ON_CHANGE_MODE, {}, },
        { "LSM330DLC Gyroscope Sensor",
          "STMicroelectronics",
          1, SENSORS_GYROSCOPE_HANDLE,
          SENSOR_TYPE_GYROSCOPE, RANGE_GYRO, CONVERT_GYRO, 6.1f, 1190, 0, 0, 0, 0, 0,
		SENSOR_FLAG_ON_CHANGE_MODE, {}, },
        { "BMP182 Pressure sensor",
          "Bosch",
          1, SENSORS_PRESSURE_HANDLE,
          SENSOR_TYPE_PRESSURE, 1100.0f, 0.01f, 0.06f, 50000, 0, 0, 0, 0, 0,
